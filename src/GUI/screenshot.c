/* --------------------------------------------- */
/* The Screenshot.c file is used for taking a    */
/* screenshot of the brain. This is used to help */
/* us to save images for our engineering         */
/* notebook. As well as debugging brain UI       */
/* development. None of this code has been       */
/* written by any members of team 333R, it has   */
/* however been modified to work for our program */
/* --------------------------------------------- */
...
void screenshot(const char * fname)
{
    ...
    if(has_init)
    {
        ...
        sprintf(scr_fname,"/usd/%s %d.tga",fname , i);
